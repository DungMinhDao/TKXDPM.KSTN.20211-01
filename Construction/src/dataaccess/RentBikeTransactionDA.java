 ...
 */
public class RentBikeTransactionDA {
    /**
     ...
     */public static ArrayList<ArrayList<String>> queryByRentalCode(String rentalCode){
        String command = "SELECT * FROM rentbiketransaction WHERE rentalCode=" + '\'' + rentalCode + '\''+"and rentBikeCost = -1";
     ...
     * @param returnTime: thời điểm trả xe
     */
    public static void updateReturnTimeAndCost(String rentalCode, int rentBikeCost, String returnTime,String rentTime){
        String command = "UPDATE rentbiketransaction SET rentBikeCost=" + rentBikeCost + ", returnTime=" + '\'' + returnTime + '\'' + " WHERE rentalCode=" + '\'' + rentalCode + '\'' +"and rentTime="+'\''+rentTime+'\'';
        MySQLDB.execute(command);
    }
}
