    ...
    public static final Bike getBike(ArrayList<String> bike) {
        switch (bike.get(5)) {
            case "Xe đạp đơn thường":
                ...
                singleBike.setInUse(bike.get(1).equals("0")?false:true);
            ...
            case "Xe đạp đôi thường":
                ...
                doubleBike.setInUse(bike.get(1).equals("0")?false:true);
            ...
            case "Xe đạp đơn điện":
                ...
                singleElectricBike.setInUse(bike.get(1).equals("0")?false:true);
